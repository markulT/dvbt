...
const Checkout:FC = () => {
    return (
        <div className="bg-white-bg flex">
            <main className="flex flex-col w-full">
                        ...
                        <div className="flex justify-center flex-col lg:flex-row lg:justify-between">
                            <div className="flex flex-col items-center lg:items-start">
                                ...
                                <div className="lg:flex lg:gap-4 items-center justify-start">
                                    ...
                                    <div className="flex rounded-full justify-center hover:scale-110 transition-all duration-500 mt-4 lg:mt-0">
                                        <div className="flex items-center justify-center p-4 bg-white drop-shadow-xl rounded-full">
                ...
                <section className="mx-4 sm:mx-10 md:mx-20 lg:mx-28 mt-10">
                    ...
                    <div className="grid grid-cols-3 grid-rows-3 gap-4 gap-x-60">
                        ...
                        <button className={"bg-gradient-to-r from-blue-1 to-yellow-4 rounded-md m-3 hover:scale-105 transition-all duration-500"}>
                            Оплатити покупку
                        </button>
